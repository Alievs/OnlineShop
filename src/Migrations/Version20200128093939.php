 ...
 */
final class Version20200128093939 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cart_line CHANGE unitz_price total_price INT NOT NULL');
        $this->addSql('ALTER TABLE cart ADD sold TINYINT(1) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cart DROP sold');
        $this->addSql('ALTER TABLE cart_line CHANGE total_price unitz_price INT NOT NULL');
    }
}
